...
public class viewr extends JFrame implements ActionListener
{
...
setTitle("Node Details :: ALBAR Load Balancing Geographic Routing Around Connectivity Holes in WSN");
c= getContentPane();
c.setLayout (null);
