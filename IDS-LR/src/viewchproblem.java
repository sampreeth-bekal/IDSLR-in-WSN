...
public class viewchproblem extends JFrame implements ActionListener
{
...
setTitle("Connection Hole Node Details :: ALBAR Load Balancing Geographic Routing Around Connectivity Holes in WSN");
c= getContentPane();
c.setLayout (null);
		...
		Vector heading = new Vector();
		 ...
		 heading.addElement("Reason");
				  ...
				  DBCon db = new DBCon();
		             ...
		             String query = "SELECT * From chproblem ";
